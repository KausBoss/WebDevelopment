			...
			(function(window) {
				var i,
					...
					funescape = function(escape, nonHex) {
						...
						return
							nonHex ? // Strip the backslash prefix from a non-hex escape sequence
							nonHex :
				...
				try {
					...
					push = {
						apply:
							arr.length ? // Leverage slice if possible
							function(target, els) {
	...
	---------------------------------------------------------------------- */
					...
					sortOrder =
						...
						function(a, b) {
							...
							return
								i ? // Do a sibling check if the nodes have a common ancestor
			...
			*/
					...
					filter: {
						...
						CHILD: function(type, what, _argument, first, last) {
							...
							return
								first === 1 && last === 0 ? // Shortcut for :nth-*(n)
								function(elem) {
					...
					return markFunction(function(seed, results, context, xml) {
						var temp,
							...
							matcherIn =
									...
									elems,
							matcherOut =
								matcher ? // If we have a postFinder, or filtered seed, or non-seed postFilter or preexisting results,
								postFinder ||
								(
									seed ? preFilter :
 ...
 */
		...
		function curCSS(elem, name, computed) {
			...
			return
				ret !== undefined ? // Support: IE <=9 - 11 only
 ...
 */
		...
		*/
			...
			ajaxSetup: function(target, settings) {
				return
					settings ? // Building a settings object
